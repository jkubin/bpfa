/* the most common CRC look-up tables
 ...
 * (normal/reversed: 0x8005/0xa001)
 */

const unsigned short crc16_ibm[] = {
 ...
 * (normal/reversed: 0x1021/0x8408)
 */

const unsigned short crc16_ccitt[] = {
